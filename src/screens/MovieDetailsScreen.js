...
import { View, Text, Image, ImageBackground , StyleSheet, SafeAreaView, ScrollView, TouchableOpacity} from 'react-native';
      ...
      <View style={{flex: 0.9}}>
       ...
       <ScrollView>
        ...
        <View style={{  alignItems: 'center' }}>                           
            <Text style={{fontSize:20, fontWeight:"bold", color:"#ffffff"}}>{movie.rating/2}</Text>  
            <Rating ratings = {movie.rating/2} />   
        </View> 
        </View>
        
       <View style={[styles.row, {marginTop: 20, maxWidth:200}]}>
             <Text style={{fontFamily:'Kanit-SemiBold', fontSize:20,  color:"#ffffff", lineHeight:27,
            textAlign:'justify' }}>{movie.title.rendered } ({movie.themeum_movie_release_year})</Text> 
       </View>
       ...
       <View style={styles.row}>
            ...
            <Text style={[styles.subheader, {textTransform:'capitalize'}]}> { movie.themeum_movie_director} </Text>                  
       </View>
