...
<ScrollView style={{flex: 1}}>
  ...
  <Text style={styles.subheader}> { movie.themeum_release_date}</Text>                  
     ...
     <View style={styles.row}>
          ...
          <Text style={styles.subheader}> { movie.themeum_movie_director} </Text>                  
     </View>
     
     <View style={styles.column}>
          <Text style={styles.headers}>Actors : </Text>   
          <Text style={styles.subheader}>{movie.themeum_movie_actor} </Text>                  
     </View>
     
     <View style={styles.column}>
          <Text style={styles.headers}>Genre : </Text>   
          <Text style={styles.subheader}>{movie.themeum_movie_type} </Text>                  
     </View>
